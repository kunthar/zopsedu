...
from zopsedu.bap.lib.form.common import HAKEM_ARA_RAPOR


class HakemAraRaporFormu1(FlaskForm):
    """Example form to test migrate_forms command"""

    class Meta(DefaultMeta):
        """Example Form Meta"""
        form_name = "Hakem Ara Rapor Örnek Form 1"
        form_type = HAKEM_ARA_RAPOR
