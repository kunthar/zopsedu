...
main() {
  stop_and_rm_if_exists
  sleep 2
  run_postgres; sleep 3 &&  upgrade_and_migrate; sleep 2 && insert_birim_agaci; sleep 2  && copy_butce_detaylari_file; sleep 2 && insert_butce_detaylari; sleep 2 && insert_data;
}
